...
const SignInScreen = () => {
	...
	const { rememberMe, setRememberMe, handleRememberMeStorage } =
		useRememberMe({ formData, setFormData });

	const onSubmit = async () => {
		await handleRememberMeStorage(formData.username, formData.password);
							...
							<View className="gap-6">
								<View className="gap-1">
									...
									<TextInput
										...
										className="font-poppins h-11 w-full rounded-[8px] border border-[#F0F0F0] py-2 px-3 bg-white text-sm"
